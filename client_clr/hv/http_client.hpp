...
HV_EXPORT int http_client_send_async(http_client_t* cli, HttpRequestPtr req, HttpResponseCallback resp_cb);
...
HV_EXPORT int http_client_send_async(HttpRequestPtr req, HttpResponseCallback resp_cb);
...
public:
    ...
    // async
    int sendAsync(HttpRequestPtr req, HttpResponseCallback resp_cb = nullptr) {
